...
const LOCALES = {
  ...
  fr: {
    ...
    saved_prompts_save_current: 'Sauvegarder l\'entrée actuelle comme invite',
    ...
    terminal_remote_backend_unsupported: 'Le terminal intégré est uniquement pris en charge avec des backends de terminal locaux.',
    ...
    new_file_prompt_title: 'Nouveau nom de fichier dans {0} :',
    new_folder_prompt_title: 'Nouveau nom de dossier dans {0} :',
    ...
    settings_desc_token_speed: 'Affiche les jetons par seconde dans les en-têtes des messages de l\'assistant pendant la diffusion en continu et après la fin d\'une réponse. Désactivé par défaut.',
    ...
    settings_label_pinned_limit: 'Limite de conversations épinglées',
    ...
    settings_desc_dashboard_mode: 'Afficher un lien dans la barre de navigation lorsque le tableau de bord officiel hermes est accessible. Les URL de proxy inverse public sont stockées uniquement comme liens dans le navigateur et ne sont jamais sondées par le serveur.',
    ...
    gateway_not_running: 'Passerelle non active',
    ...
    cron_mode_script: 'Script',
    cron_mode_label: 'Mode',
    cron_script_job_banner: 'Exécute un script selon l\'horaire — stdout est livré à la cible. Pas d\'agent, prompt ni skills.',
    cron_script_card_title: 'Script',
  ...
  pl: {
    ...
    cmd_steer_fallback: 'Korekta niedostępna — dodano do kolejki na następną turę',
    ...
    busy_steer_fallback: 'Korekta niedostępna — dodano do kolejki na następną turę',
    ...
    kanban_rename_board: 'Zmień nazwę bieżącej tablicy…',
    ...
    settings_desc_shutdown: 'Bezpiecznie zatrzymuje lokalny serwer WebUI. Przydatne, jeśli uruchomiłeś go przez <code>./ctl.sh start</code> i chcesz zatrzymać bez przełączania się do terminala. Będziesz musiał ponownie uruchomić serwer (<code>./ctl.sh start</code> lub aplikację natywną), zanim WebUI będzie ponownie osiągalny.',
